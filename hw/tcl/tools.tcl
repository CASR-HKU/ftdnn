...
for {set idx_d2 0} {$idx_d2 < $HW_D2} {incr idx_d2} {
    for {set idx_d1 0} {$idx_d1 < $HW_D1} {incr idx_d1} {
        ...
        set cell_name_pattern "sblk_col[$idx_d2]*/tpe[$idx_d1]*/RAMB18E2_inst"
        # open mem file
        ...
        for {set xx 0} {$xx < 64} {incr xx} {
            ...
            set_property $prop_name $prop_val [get_cells $cell_name_pattern]
            # test if set right
            set rd_val [get_property $prop_name [get_cells $cell_name_pattern]]
