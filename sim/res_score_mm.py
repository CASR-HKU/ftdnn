...
def res_score_mm(sol, perf, hw_conf, workload, dram_rd_bw=20, dram_wr_bw=20, remain_len=5000, w_exe=1, w_bw=1, w_wbram=1):

    # theoretical number
    n_op = workload['M']*workload['N']*workload['P']
    theo_th = hw_conf['D1']*hw_conf['D2']*hw_conf['D3']
    theo_time = int(n_op/theo_th)
    theo_act_rd = workload['N']*workload['P']
    theo_psum_wr = workload['M']*workload['P']
    theo_w_consumption =  workload['M']*workload['N'] / (hw_conf['D1']*hw_conf['D2']*hw_conf['D3'])
    ...
    for idx in range(0, num_sol):
        ...
        timebound_bus_act_rd = act_rd * sol[idx][3] / hw_conf['D3']
